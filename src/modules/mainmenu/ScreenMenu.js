...
var ScreenMenu = cc.Layer.extend({
    ...
    ctor:function() {
        ...
        // button start
        this.btnStart = cc.Sprite.create("assests/game/golddigger/images/buttonstart-sheet0.png");
        ...
        this.sunrays = cc.Sprite.create("assests/game/golddigger/images/sunrays-sheet0.png");
        ...
        // logo
        this.logo = cc.Sprite.create("assests/game/golddigger/images/gamelogo-sheet0.png");
    ...
    generateItem:function()
    {
        ...
        for(var i = 1; i <= itemsCount; i++)
        {
            let item;
            switch (i%17) {
                case 0: item = cc.Sprite.create("assests/game/golddigger/images/skull-sheet0.png"); break;
                case 1: item = cc.Sprite.create("assests/game/golddigger/images/gold_01-sheet0.png"); break;
                case 2: item = cc.Sprite.create("assests/game/golddigger/images/gold_02-sheet0.png"); break;
                case 3: item = cc.Sprite.create("assests/game/golddigger/images/gold_03-sheet0.png"); break;
                case 4: item = cc.Sprite.create("assests/game/golddigger/images/gold_05-sheet0.png"); break;
                case 5: item = cc.Sprite.create("assests/game/golddigger/images/gold_10-sheet0.png"); break;
                case 6: item = cc.Sprite.create("assests/game/golddigger/images/rock_01-sheet0.png"); break;
                case 7: item = cc.Sprite.create("assests/game/golddigger/images/rock_04-sheet0.png"); break;
                case 8: item = cc.Sprite.create("assests/game/golddigger/images/rock_07-sheet0.png"); break;
                case 9: item = cc.Sprite.create("assests/game/golddigger/images/rock_10-sheet0.png"); break;
                case 10: item = cc.Sprite.create("assests/game/golddigger/images/bonus-sheet0.png"); break;
                case 11: item = cc.Sprite.create("assests/game/golddigger/images/bonusbomb-sheet0.png"); break;
                case 12: item = cc.Sprite.create("assests/game/golddigger/images/jewel_01-sheet0.png"); break;
                case 13: item = cc.Sprite.create("assests/game/golddigger/images/jewel_02-sheet0.png"); break;
                case 14: item = cc.Sprite.create("assests/game/golddigger/images/jewel_03-sheet0.png"); break;
                case 15: item = cc.Sprite.create("assests/game/golddigger/images/barrel-sheet0.png"); break;
                case 16: item = cc.Sprite.create("assests/game/golddigger/images/treasure-sheet0.png"); break;
            }
            let overwrite = false;
            let randomCount = 0;
            do {
